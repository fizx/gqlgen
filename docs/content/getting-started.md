...
```bash
$ go run github.com/fizx/gqlgen init
```
...
And run `go run github.com/fizx/gqlgen generate`.
...
```go
//go:generate go run github.com/fizx/gqlgen
```
